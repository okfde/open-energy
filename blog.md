...
{% if featured_post %}
{% capture featured_categories %}{% include category-list.html categories=featured_post.category %}{% endcapture %}
<section class="section section--sand" data-category-item="{{ featured_categories | strip }}">
