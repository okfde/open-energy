...
(function () {
  ...
  function popupHtml(props) {
    ...
    var rows = [
      ["Dach-Potenzialfläche", fmtNum(props.dach_flaeche_qm, 0) + " m²"],
      ["… davon gute Ausrichtung", fmtNum(props.dach_flaeche_gut_qm, 0) + " m²"],
      ...
      ["Amtliches Potenzial (Vergleich)", fmtNum(props.dach_leistung_amtlich_kwp, 0) + " kWp / " + fmtCompact(props.dach_menge_amtlich_mwh * 1000) + " kWh/a"],
